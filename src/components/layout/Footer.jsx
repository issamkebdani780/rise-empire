...
const Footer = () => {
  ...
  return (
    <footer className="py-20 border-t border-slate-100 dark:border-white/5 bg-white dark:bg-background transition-colors duration-500">
        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="col-span-2 space-y-6">
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-slate-900 flex items-center justify-center text-slate-400 hover:bg-pink-600 hover:text-white transition-all border border-slate-100 dark:border-slate-800">
